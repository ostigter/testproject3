...
/*
 * OK, this really shouldn't be here, we shoudl create a CoreTableColumnSWT that implements this listener logic, but I'm not sure exactly
 */
...
public abstract class CoreTableColumn extends TableColumnImpl implements TableColumnExtraInfoListener {
     ...
     * @param iAlignment
     *            See {@link #getAlignment()}
     * @param iPosition
     *            See {@link TableColumn#setPosition(int)}
     * @param iWidth
     *            See {@link TableColumn#setWidth(int)}
     * @param sTableID
     *            See {@link TableManager}_TABLE*
     */
     ...
     * Construct a new CoreTableColumn.
     * <p>
     * Alignment will be ALIGN_LEAD, Type will be TYPE_TEXT, Position will be POSITION_INVISIBLE, Width will be 50, Update Interval will be
