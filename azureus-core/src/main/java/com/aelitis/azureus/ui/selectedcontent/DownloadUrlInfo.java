...
public class DownloadUrlInfo {
    ...
    public boolean sameAs(DownloadUrlInfo other) {
        ...
        return (objectEquals(dlURL, other.dlURL) && objectEquals(referer, other.referer)
                && objectEquals(requestProperties, other.requestProperties) && objectEquals(additionalProperties, other.additionalProperties));
    }
}
