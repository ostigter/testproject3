...
public class WebResult extends Result {
    ...
    public void setCategoryFromHTML(String category) {
        if (category != null) {
            ...
            /*
             * int separator = this.category.indexOf(">"); if(separator != -1) { this.category = this.category.substring(separator+1).trim(); }
             */
        }
    }
    ...
    private String reConstructLink(String link) {
        if (link != null) {
            ...
            if (lc_link.startsWith("http://") || lc_link.startsWith("https://") || lc_link.startsWith("azplug:") || lc_link.startsWith("magnet:")
                    || lc_link.startsWith("bc:") || lc_link.startsWith("bctp:") || lc_link.startsWith("dht:")) {
