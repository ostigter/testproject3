...
public interface DiskAccessRequestListener {
    ...
    /**
     * Called to indicate that an actual request operation occurred. If this request has been aggregated with others then the byted reported will be
     * for the contiguous region and subsequent aggregated requests will be reported with 0 bytes
     * 
     * @param bytes
     */
