...
class TranscodeFileImpl implements TranscodeFile {
    ...
    protected TranscodeFileImpl(DeviceImpl _device, String _key, String _profile_name, Map<String, Map<String, ?>> _files_map, File _file,
            boolean _for_job) {
        device = _device;
        key = _key;
