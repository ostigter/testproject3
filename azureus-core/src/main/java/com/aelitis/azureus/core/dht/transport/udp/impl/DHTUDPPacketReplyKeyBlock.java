...
public class DHTUDPPacketReplyKeyBlock extends DHTUDPPacketReply {
    public DHTUDPPacketReplyKeyBlock(DHTTransportUDPImpl transport, int trans_id, long conn_id, DHTTransportContact local_contact,
