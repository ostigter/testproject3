...
public class BTPiece implements BTMessage {
    ...
    public String getID() {
        return BTMessage.ID_BT_PIECE;
    }

    public byte[] getIDBytes() {
        return BTMessage.ID_BT_PIECE_BYTES;
    }
    ...
    public int getFeatureSubID() {
        return BTMessage.SUBID_BT_PIECE;
    }
    ...
    public String getDescription() {
        if (description == null) {
            description =
                    BTMessage.ID_BT_PIECE + " data for piece #" + piece_number + ":" + piece_offset + "->" + (piece_offset + piece_length - 1);
        }
