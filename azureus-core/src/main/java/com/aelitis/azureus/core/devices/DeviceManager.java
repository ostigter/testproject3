...
public interface DeviceManager {
    ...
    Device addInetDevice(int type, String uid, String classification, String name, InetAddress address)

    throws DeviceManagerException;

    public void search(int max_millis, DeviceSearchListener listener);
