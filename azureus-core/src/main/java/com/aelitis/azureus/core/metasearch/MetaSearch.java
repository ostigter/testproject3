...
public interface MetaSearch {
    ...
    public Engine[] search(ResultListener listener, SearchParameter[] searchParameters, String headers, int max_per_engine);

    public Engine[] search(ResultListener listener, SearchParameter[] searchParameters, String headers, Map<String, String> context,
            int max_per_engine);

    public Engine[] search(Engine[] engine, ResultListener listener, SearchParameter[] searchParameters, String headers, int max_per_engine);

    public Engine[] search(Engine[] engine, ResultListener listener, SearchParameter[] searchParameters, String headers,
    ...
    public void exportEngines(File to_file)
