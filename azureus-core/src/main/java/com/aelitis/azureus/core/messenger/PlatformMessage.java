...
public class PlatformMessage {
            ...
            try {
                if (parameters[i] instanceof String) {
                    if (parameters[i + 1] instanceof String[]) {
                        ...
                        result.put((String) parameters[i], parseParams((Object[]) parameters[i + 1]));
    ...
    public String toString() {
        ...
        return "PlaformMessage {" + lSequenceNo + ", " + messageID + ", " + listenerID + ", " + operationID + ", "
                + (paramString.length() > 32767 ? paramString.substring(0, 32767) : paramString) + "}";
    }
