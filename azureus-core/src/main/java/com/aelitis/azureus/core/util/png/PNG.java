...
public class PNG {
    ...
    /*
     * public static void main(String args[]) throws Exception { File test = new File("/Users/olivier/Desktop/test.png"); FileOutputStream fos = new
     * FileOutputStream(test); fos.write(getPNGBytesForSize(600,400)); fos.close(); }
     */
}
