...
public class ContentNetworkVuze extends ContentNetworkVuzeGeneric {
    ...
    /*
     * static{ if ( FeatureAvailability.ENABLE_PLUS()){ if ( System.getProperty( "platform_address", "" ).length() == 0 ){ System.setProperty(
     * "platform_address", "www2.vuze.com" ); } } }
     */
    ...
    private static final String URL_EXT_PREFIX = "http://" + System.getProperty("platform_address_ext", DEFAULT_EXT_ADDRESS) + ":"
    ...
    private static String URL_RELAY_RPC = System.getProperty("relay_url", "http://" + System.getProperty("relay_address", DEFAULT_RELAY_ADDRESS)
            + ":" + System.getProperty("relay_port", DEFAULT_RELAY_PORT) + "/msgrelay/rpc");

    private static final String URL_AUTHORIZED_RPC = System.getProperty("authorized_rpc", "1").equals("1") ? DEFAULT_AUTHORIZED_RPC : URL_PREFIX
            + "app";
    ...
    protected ContentNetworkVuze(ContentNetworkManagerImpl manager) {
        super(manager, ContentNetwork.CONTENT_NETWORK_VUZE, 1, "Vuze HD Network", null, null, URL_ADDRESS, URL_PREFIX, null, // no icon
                URL_RELAY_RPC, URL_AUTHORIZED_RPC, URL_FAQ, URL_BLOG, URL_FORUMS, URL_WIKI, URL_EXT_PREFIX);
    }
}
