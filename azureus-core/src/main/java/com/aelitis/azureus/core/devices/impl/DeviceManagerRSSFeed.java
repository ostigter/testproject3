    ...
    throws IOException {
        ...
        if (path.length() <= 1) {
            ...
            for (DeviceImpl d : devices) {
                ...
                pw.println("<LI><A href=\"" + device_url + "\">" + name + "</A>&nbsp;&nbsp;-&nbsp;&nbsp;<font size=\"-1\"><a href=\"" + device_url
                        + "?format=html\">html</a></font></LI>");
            }
            ...
            if (html) {
                ...
                try {
                    ...
                    pw.println("<rss version=\"2.0\" " + "xmlns:vuze=\"http://www.vuze.com\" " + "xmlns:media=\"http://search.yahoo.com/mrss/\" "
                    ...
                    pw.println("<image><url>http://www.vuze.com/img/vuze_icon_128.png</url><title>" + channel_title
                            + "</title><link>http://vuze.com</link></image>");
                    ...
                    for (TranscodeFileImpl file : files) {
                        ...
                        try {
                            ...
                            if (stream_url != null) {
                                ...
                                pw.println("<enclosure url=\"" + url_ext + "\" length=\"" + fileSize
                                        + (mime_type == null ? "" : "\" type=\"" + mime_type) + "\"></enclosure>");
                            }
                            ...
                            try {
                                ...
                                if (description != null) {
                                    ...
                                    /*
                                     * if ( thumb_url != null ){ pw.println( "<description type=\"text/html\">" + escape(
                                     * "<div style=\"text-align: justify;padding: 5px;\"><img style=\"float: left;margin-right: 15px;margin-bottom: 15px;\" src=\""
                                     * + thumb_url + "\"/>" ) + description + escape( "</div>" ) + "</description>" ); }else{
                                     */
