...
public class DeviceManagerUPnPImpl {
    ...
    protected void startUp() {
        ...
        try {
            ...
            upnp.getSSDP().addListener(new UPnPSSDPListener() {
                ...
                public void receivedResult(NetworkInterface network_interface, InetAddress local_address, InetAddress originator, String USN,
                        URL location, String ST, String AL) {
                }

                public void receivedNotify(NetworkInterface network_interface, InetAddress local_address, InetAddress originator, String USN,
                        URL location, String NT, String NTS) {
        ...
        try {
            IPCInterface my_ipc = new IPCInterfaceImpl(new Object() {
                public Map<String, Object> browseReceived(TrackerWebPageRequest request, Map<String, Object> browser_args) {
                    ...
                    /**
                     * System.out.println( "Received browse: " + request.getClientAddress() + ", agent=" + user_agent + ", info=" + client_info +
                     * ", handled=" + handled + ", " + request.getURL()); System.out.println("\n\n"); /
                     **/
                                            ...
                                            if (skip) {
                                                ...
                                                synchronized (access_logs) {
                                                    ...
                                                    if (!access_logs.contains(host)) {
                                                        ...
                                                        manager.log("Ignoring browse from " + host + " due to access restriction for '"
                                                                + renderer.getName() + "'");
                                                    }
                                                }
                                            }
    ...
    public void search() {
        if (upnp != null) {
            ...
            String[] STs = { "upnp:rootdevice", "urn:schemas-upnp-org:device:MediaRenderer:1", "urn:schemas-upnp-org:service:ContentDirectory:1", };
