...
public class PlatformConfigMessenger {
    ...
    public static void login(long maxDelayMS) {
        ...
        Object[] params =
                new Object[] { "version", org.gudy.azureus2.core3.util.Constants.AZUREUS_VERSION, "locale",
                        MessageText.getCurrentLocale().toString(), "vid", COConfigurationManager.getStringParameter("ID"), };
        ...
        PlatformMessengerListener listener = new PlatformMessengerListener() {
            ...
            public void replyReceived(PlatformMessage message, String replyType, Map reply) {
                ...
                boolean allowMulti = MapUtils.getMapBoolean(reply, "allow-multi-rpc", PlatformMessenger.getAllowMulti());
                ...
                try {
                    List listURLs = (List) MapUtils.getMapObject(reply, "url-blacklist", null, List.class);
                    if (listURLs != null) {
                        for (int i = 0; i < listURLs.size(); i++) {
                            String string = (String) listURLs.get(i);
    ...
    public static void logPlugin(String event, String pluginID) {
        ...
        try {
            PlatformMessage message =
                    new PlatformMessage("AZMSG", LISTENER_ID, OP_LOG_PLUGIN, new Object[] { "event", event, "plugin-id", pluginID, }, 5000);
    ...
    public static void sendUsageStats(Map stats, long timestamp, String version, PlatformMessengerListener l) {
        ...
        try {
            PlatformMessage message =
                    new PlatformMessage("AZMSG", LISTENER_ID, "send-usage-stats2", new Object[] { "stats", stats, "version", version, "timestamp",
                            new Long(timestamp), "ago-ms", new Long(SystemTime.getCurrentTime() - timestamp), }, 5000);
    ...
    public static void sendVersionServerMap(Map mapVerServer) {
        ...
        try {
            PlatformMessage message = new PlatformMessage("AZMSG", LISTENER_ID, "send-version-info", mapVerServer, 5000);
