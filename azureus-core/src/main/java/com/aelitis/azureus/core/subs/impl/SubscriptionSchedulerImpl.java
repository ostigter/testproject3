...
public class SubscriptionSchedulerImpl implements SubscriptionScheduler, SubscriptionManagerListener {
    ...
    throws SubscriptionException {
        download(subs, is_auto, new SubscriptionDownloadListener() {
    ...
    public void download(Subscription subs, boolean is_auto)
    ...
    public void download(final Subscription subs, final SubscriptionResult result) {
        ...
        synchronized (active_result_downloaders) {
            ...
            result_downloader.dispatch(new AERunnable() {
                                    ...
                                    while (true) {
                                        ...
                                        try {
                                            ...
                                            ResourceDownloader url_rd =
                                                    rdf.create(current_url, plugin_proxy == null ? null : plugin_proxy.getProxy());
    ...
    protected void calculateSchedule() {
        ...
        synchronized (this) {
            ...
            if (next_ready_time < Long.MAX_VALUE) {
                ...
                log("Calculate : " + "old_time=" + new SimpleDateFormat().format(new Date(old_when)) + ", new_time="
                        + new SimpleDateFormat().format(new Date(next_ready_time)));

                schedule_event = SimpleTimer.addEvent("SS:Scheduler", next_ready_time, new TimerEventPerformer() {
