...
public interface SubscriptionHistory {
    ...
    public void setAutoDownload(boolean auto_dl);

    public void setDetails(boolean enabled, boolean auto_dl);
    ...
    public void markResults(String[] result_ids, boolean[] read);
