...
public abstract class Result {
    ...
    /*
     * public String getNameHTML() { if(getName() != null) { return( getName()); //return( XUXmlWriter.escapeXML( getName())); //return
     * Entities.XML.escape(getName()); } return null; } public String getCategoryHTML() { if(getCategory() != null) { return( getCategory()); //return
     * Entities.XML.escape(getCategory()); } return null; }
     */
    ...
    protected float applyRankBias(float _rank) {
        ...
        /*
         * if ( rank != _rank ){ System.out.println( "bias applied for " + engine.getName() + ": " + _rank + "-> " + rank ); }
         */
