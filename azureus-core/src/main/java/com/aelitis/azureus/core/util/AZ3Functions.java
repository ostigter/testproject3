...
public class AZ3Functions {
    ...
    public interface provider {
        ...
        public boolean canPlay(DownloadManager dm, int file_index);

        public void play(DownloadManager dm, int file_index);

        public void setOpened(DownloadManager dm, boolean opened);
