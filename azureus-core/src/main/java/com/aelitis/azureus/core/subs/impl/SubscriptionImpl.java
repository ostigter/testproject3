...
public class SubscriptionImpl implements Subscription {
    ...
    // private static final byte[] GENERIC_PRIVATE_KEY =
    // {(byte)0x71,(byte)0xc3,(byte)0xe8,(byte)0x6c,(byte)0x56,(byte)0xbb,(byte)0x30,(byte)0x14,(byte)0x9e,(byte)0x19,(byte)0xa5,(byte)0x3d,(byte)0xcb,(byte)0x47,(byte)0xbb,(byte)0x6d,(byte)0x57,(byte)0x57,(byte)0xd3,(byte)0x59,(byte)0xce,(byte)0x8f,(byte)0x79,(byte)0xe5};
    ...
    protected SubscriptionImpl(SubscriptionManagerImpl _manager, String _name, boolean _public, Map _singleton_details, String _json_content,
            int _add_type)
    ...
    throws SubscriptionException {
        ...
        try {
            ...
            SubscriptionBodyImpl body =
                    new SubscriptionBodyImpl(manager, name, is_public, json_content, public_key, version, az_version, singleton_details);
        ...
        try {
            ...
            if (id == engine.getId()) {
                ...
                SubscriptionImpl subs =
                        new SubscriptionImpl(manager, getName(), engine.isPublic(), null, JSONUtils.encodeToJSON(map),
                ...
                if (create) {
                    ...
                    try {
                        ...
                        if (original_data_location.exists()) {
                            ...
                            final File versioned_data_location =
                                    new File(original_data_location.getParent(), original_data_location.getName() + "." + getVersion());
                            ...
                            lws =
                                    LightWeightSeedManager.getSingleton().add(getName(), new HashWrapper(hash),
                                            TorrentUtils.getDecentralisedEmptyURL(), versioned_data_location, new LightWeightSeedAdapter() {
                                                ...
                                                throws Exception {
                                                    ...
                                                    TOTorrentCreator creator =
                                                            TOTorrentFactory.createFromFileOrDirWithFixedPieceLength(data_location, announce_url,
                                                                    256 * 1024);
    ...
    public String getString() {
        return ("name=" + name + ",sid=" + ByteFormatter.encodeString(short_id) + ",ver=" + version + ",pub=" + is_public + ",mine=" + isMine()
                + ",sub=" + is_subscribed + (is_subscribed ? (",hist={" + history.getString() + "}") : "") + ",pop=" + popularity + (server_publication_outstanding
                    ? ",spo=true" : ""));
    }
