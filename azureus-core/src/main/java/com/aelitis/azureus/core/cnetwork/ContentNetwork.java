...
public interface ContentNetwork {
    ...
    public void setStartupNetwork(boolean is_startup);
    ...
    /**
     * @param topic
     *            The topic number or a pre-defined topic constant found in <code>FAQTopics</code>
     */
    ...
    public String getAddFriendURL(String bg_colour);
     ...
     * 
     * @param url_in
     *            base URL onto which the suffix should be appended
     * @param for_post
     *            whether this is for an HTTP 'POST' operation, in which case the parameter separator is always an '&' (for 'GET' the first param uses
     *            a '?' sep)
     * @param include_azid
    ...
    public void setPersistentProperty(String name, Object value);
