...
/**
 * It turns out that the number of standard ways the fields in a DN should be encoded into their ASN.1 counterparts is rapidly approaching the number
 * of machines on the internet. By default the X509Name class will produce UTF8Strings in line with the current recommendations (RFC 3280).
 * <p>
...
public abstract class X509NameEntryConverter {
     ...
     * 
     * @param str
     *            the hex encoded object
     * @param off
     *            the index at which the encoding starts
     ...
     * 
     * @param oid
     *            the oid associated with the value in the DN.
     * @param value
