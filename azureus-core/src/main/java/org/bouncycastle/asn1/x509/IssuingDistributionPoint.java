...
public class IssuingDistributionPoint extends ASN1Encodable {
     ...
     * @param indirectCRL
     *            If <code>true</code> then the CRL contains revocation information about certificates ssued by other CAs.
     * @param onlyContainsAttributeCerts
     *            Covers revocation information for attribute certificates.
     */
    public IssuingDistributionPoint(DistributionPointName distributionPoint, boolean onlyContainsUserCerts, boolean onlyContainsCACerts,
            ReasonFlags onlySomeReasons, boolean indirectCRL, boolean onlyContainsAttributeCerts) {
        ...
        if (distributionPoint != null) { // CHOICE item so explicitly tagged
