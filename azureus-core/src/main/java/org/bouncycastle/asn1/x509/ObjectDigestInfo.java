...
public class ObjectDigestInfo extends ASN1Encodable {
     ...
     * <p>
     * If <code>digestedObjectType</code> is not {@link #publicKeyCert} or {@link #publicKey} <code>otherObjectTypeID</code> must be given, otherwise
     * it is ignored.
     * 
     * @param digestedObjectType
     *            The digest object type.
     * @param otherObjectTypeID
     *            The object type ID for <code>otherObjectDigest</code>.
