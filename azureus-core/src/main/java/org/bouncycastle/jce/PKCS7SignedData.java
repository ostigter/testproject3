 ...
 * </pre>
 * <p>
 * This class is pretty close to obsolete, for a much better (and more complete) implementation of PKCS7 have a look at the org.bouncycastle.cms
 * package.
 */
public class PKCS7SignedData implements PKCSObjectIdentifiers {
     ...
     */
    public PKCS7SignedData(byte[] in) throws SecurityException, CRLException, InvalidKeyException, CertificateException, NoSuchProviderException,
     ...
     */
    public PKCS7SignedData(byte[] in, String provider) throws SecurityException, CRLException, InvalidKeyException, CertificateException,
     ...
     * @param the
     *            certifiacate chain associated with the private key.
     * @param hashAlgorithm
     *            the hashing algorithm used to compute the message digest. Must be "MD5", "MD2", "SHA1" or "SHA"
     */
    public PKCS7SignedData(PrivateKey privKey, Certificate[] certChain, String hashAlgorithm) throws SecurityException, InvalidKeyException,
            NoSuchProviderException, NoSuchAlgorithmException {
     ...
     *            the provider to use.
     */
    public PKCS7SignedData(PrivateKey privKey, Certificate[] certChain, String hashAlgorithm, String provider) throws SecurityException,
     ...
     *            the certificate chain associated with the private key.
     * @param crlList
     *            the crl list associated with the private key.
     * @param hashAlgorithm
     *            the hashing algorithm used to compute the message digest. Must be "MD5", "MD2", "SHA1" or "SHA"
     * @param provider
     *            the provider to use.
    ...
    public byte[] getEncoded() {
        try {
            ...
            IssuerAndSerialNumber isAnds =
                    new IssuerAndSerialNumber(new X509Name((ASN1Sequence) getIssuer(signCert.getTBSCertificate())), new DERInteger(signCert
                            .getSerialNumber()));
