...
public abstract class ECPoint {
    ...
    /**
     * Sets the <code>PreCompInfo</code>. Used by <code>ECMultiplier</code>s to save the precomputation for this <code>ECPoint</code> to store the
    ...
    public static class F2m extends ECPoint {
         ...
         * 
         * @param a
         *            The first <code>ECPoint</code> to check.
         * @param b
         *            The second <code>ECPoint</code> to check.
         * @throws IllegalArgumentException
         *             if <code>a</code> and <code>b</code> cannot be added.
         */
        ...
        /**
         * Adds another <code>ECPoints.F2m</code> to <code>this</code> without checking if both points are on the same curve. Used by multiplication
         * algorithms, because there all points are a multiple of the same point and hence the checks can be omitted.
         * 
         * @param b
         *            The other <code>ECPoints.F2m</code> to add to <code>this</code>.
        ...
        /**
         * Subtracts another <code>ECPoints.F2m</code> from <code>this</code> without checking if both points are on the same curve. Used by
         * multiplication algorithms, because there all points are a multiple of the same point and hence the checks can be omitted.
         * 
         * @param b
         *            The other <code>ECPoints.F2m</code> to subtract from <code>this</code>.
         * @return <code>this - b</code>
         */
