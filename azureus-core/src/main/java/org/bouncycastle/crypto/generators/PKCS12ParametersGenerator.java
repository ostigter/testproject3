 ...
 * <p>
 * The document this implementation is based on can be found at <a href=http://www.rsasecurity.com/rsalabs/pkcs/pkcs-12/index.html> RSA's PKCS12
 * Page</a>
 */
public class PKCS12ParametersGenerator extends PBEParametersGenerator {
    ...
    /**
     * add a + b + 1, returning the result in a. The a value is treated as a BigInteger of length (b.length * 8) bits. The result is modulo 2^b.length
     * in case of overflow.
     */
