...
public class UpdaterUtils {
    ...
    public static void checkBootstrapPlugins() {
        try {
            ...
            if (target_props != null) {
                ...
                writePluginProperties(target_props, new String[] { "plugin.class=com.aelitis.azureus.plugins.upnpmediaserver.UPnPMediaServer",
                        "plugin.name=UPnP Media Server", "plugin.id=azupnpav" });
            }
            ...
            if (target_props != null) {
                ...
                writePluginProperties(target_props, new String[] { "plugin.class=com.aelitis.azureus.plugins.featman.FeatManPlugin",
                        "plugin.name=Vuze Feature Manager", "plugin.id=aefeatman_v" });
            }
    ...
    public static boolean ensurePluginPresent(String id, String cla, String name) {
        ...
        if (target_props != null) {
            ...
            writePluginProperties(target_props, new String[] { "plugin.class=" + cla, "plugin.name=" + name, "plugin.id=" + id });
