...
public class CorePatchChecker implements Plugin, UpdatableComponent, UpdateCheckInstanceListener {
    ...
    public void checkForUpdate(UpdateChecker checker) {
        try {
            ...
            my_updates.put(inst, checker.addUpdate("Core Patch Checker", new String[0], "", new ResourceDownloader[0],
        ...
        try {
            ...
            if (CorePatchLevel.getCurrentPatchLevel() >= highest_p) {
                ...
                try {
                    ...
                    Logger.log(new LogAlert(LogAlert.UNREPEATABLE, LogAlert.AT_INFORMATION, "Patch " + highest_p_file.getName()
                            + " ready to be applied"));
