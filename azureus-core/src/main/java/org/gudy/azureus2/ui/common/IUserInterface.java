...
public interface IUserInterface {
     ...
     * 
     * @param first
     *            This UI Instance is the first on the command line and should take control of singular stuff (LocaleUtil and torrents added via
     *            Command Line).
     * @param others
     *            Indicates wether other UIs run along.
     */
