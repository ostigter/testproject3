    ...
    private final class AddUserCommand extends OptionsConsoleCommand {
        ...
        public void execute(String commandName, ConsoleInput ci, CommandLine commandLine) {
            ...
            if (!UserProfile.isValidUserType(userType.toLowerCase())) {
                ci.out.println("> AddUser: invalid profile type '" + userType + "'. Valid values are: " + UserProfile.ADMIN + ","
                        + UserProfile.USER + "," + UserProfile.GUEST);
                return;
            }
        ...
        public void execute(String commandName, ConsoleInput ci, CommandLine commandLine) {
            ...
            if (userType != null) {
                if (UserProfile.isValidUserType(userType.toLowerCase())) {
                    ...
                    ci.out.println("> ModifyUser: invalid profile type '" + userType + "'. Valid values are: " + UserProfile.ADMIN + ","
                            + UserProfile.USER + "," + UserProfile.GUEST);
                    return;
                }
            }
