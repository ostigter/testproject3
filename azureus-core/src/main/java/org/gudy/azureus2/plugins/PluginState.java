...
/**
 * This object provides information the current state of the plugin, and provides various mechanisms to query and control plugins and their
 * integration with Azureus at a low-level.
 * 
 * Most plugins will have no need to interact with this object - it is primarily used by Azureus for plugin management.
 * 
 * @since 3.1.1.1
 */
