...
/**
 * This interface defines what methods an object should have defined to be able to inform listener objects about various events which occur on a
 * download.
 * 
 * In previous versions of Azureus, the {@link Download} class was the only interface which defined these methods - now
...
public interface DownloadEventNotifier {
    ...
    /**
     * Removes a listener object added via the {@link #addTrackerListener(DownloadTrackerListener)} or
     ...
     *            The listener to add.
     * @since 2.2.0.2
     * @deprecated Use {@link #addAttributeListener(DownloadAttributeListener, TorrentAttribute, int)} instead - support for this method will be
     *             removed in future.
     */
     ...
     *            The listener to add.
     * @param attr
     *            The torrent attribute to be notified about.
     * @param event_type
     *            The type of event to be notified of, as defined on {@link DownloadAttributeListener}.
     * @since 3.0.3.5
     */
...
/**
    ...
    /**
     * Removes a listener object removed via the {@link #addCompletionListener(DownloadCompletionListener)} method.
     * 
     * @param l
     *            The listener to remove.
     * @since 3.0.5.3
