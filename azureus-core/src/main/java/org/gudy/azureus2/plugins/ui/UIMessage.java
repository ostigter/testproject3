 ...
 * </ul>
 * 
 * In the case of the main SWT interface, the use of this object will present a message box to a user. The message type indicates what sort of icon to
 * display, the input type indicates what buttons are present, the message title is the message box title and the message text is the main message to
 * be displayed.
 * 
 * <p>
 * 
...
public interface UIMessage {
    ...
    /**
     * Sets what type of message to display - use one of the <tt>MSG_</tt> constants defined here.
     */
    public void setMessageType(int msg_type);

    /**
     * Sets what type of input is allowed - use one of the <tt>INPUT_</tt> constants defined here.
     */
    public void setInputType(int input_type);

    /**
     * Sets the title for the message. For some interfaces, this means that a window will be presented, and the title of the window will be the value
     * passed here.
     */
    ...
    /**
     * This displays the message to the user. The way that the user acknowledges will be the method result - which will be one of the <tt>ANSWER_</tt>
