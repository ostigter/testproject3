...
public interface AEWin32Access {
    ...
    public String readStringValue(int type, // HKEY type from above
            String subkey, String value_name)

    throws AEWin32AccessException;

    public void writeStringValue(int type, // HKEY type from above
            String subkey, String value_name, String value_value)

    throws AEWin32AccessException;

    public int readWordValue(int type, // HKEY type from above
            String subkey, String value_name)

    throws AEWin32AccessException;

    public void writeWordValue(int type, // HKEY type from above
    ...
    public void deleteKey(int type, String subkey, boolean recursuve)
