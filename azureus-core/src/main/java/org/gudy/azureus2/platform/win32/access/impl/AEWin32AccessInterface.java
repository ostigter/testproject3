...
public class AEWin32AccessInterface {
    ...
    protected static native String readStringValue(int type, // HKEY type from above
            String subkey, String value_name)

    throws AEWin32AccessExceptionImpl;

    protected static native void writeStringValue(int type, // HKEY type from above
            String subkey, String value_name, String value_value)

    throws AEWin32AccessExceptionImpl;

    protected static native int readWordValue(int type, // HKEY type from above
            String subkey, String value_name)

    throws AEWin32AccessExceptionImpl;

    protected static native void writeWordValue(int type, // HKEY type from above
            String subkey, String value_name, int value_value)

    throws AEWin32AccessExceptionImpl;

    protected static native void deleteKey(int type, String subkey, boolean recursive)

    throws AEWin32AccessExceptionImpl;

    protected static native void deleteValue(int type, String subkey, String value_namae)

    throws AEWin32AccessExceptionImpl;

    public static native void createProcess(String command_line, boolean inherit_handles)

    throws AEWin32AccessException;

    public static native void moveToRecycleBin(String file_name)

    throws AEWin32AccessException;

    public static native void copyPermission(String from_file_name, String to_file_name)

    throws AEWin32AccessException;

    public static native boolean testNativeAvailability(String name)

    throws AEWin32AccessException;

    /*
     * public static native void ping( String address ) throws AEWin32AccessException;
     */
    ...
    public static native int shellExecute(String operation, String file, String parameters, String directory, int sw_const)

    throws AEWin32AccessExceptionImpl;

    public static native int shellExecuteAndWait(String file, String parameters)

    throws AEWin32AccessExceptionImpl;

    public static native List getAvailableDrives() throws AEWin32AccessExceptionImpl;

    public static native Map getDriveInfo(char driveLetter) throws AEWin32AccessExceptionImpl;

    public static native int setThreadExecutionState(int esFLAGS);
}
