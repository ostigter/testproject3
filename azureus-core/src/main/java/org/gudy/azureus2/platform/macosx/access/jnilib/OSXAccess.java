...
public class OSXAccess {
    ...
    public static final native int AEGetParamDesc(int theAppleEvent, int theAEKeyword, int desiredType, Object result); // AEDesc result
    ...
    // 1.04
    public static final native void initializeDriveDetection(OSXDriveDetectListener d);
