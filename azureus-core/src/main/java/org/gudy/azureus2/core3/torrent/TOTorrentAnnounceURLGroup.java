...
public interface TOTorrentAnnounceURLGroup {
    ...
    /**
     * This method will create a new set. It is not added into the current set, this must be done by the caller inserting the newly created set into
     * an array as required and calling the above "set" method.
     * 
     * @param urls
     *            the URLs for the new set
