...
public class LocaleUtilDecoderCandidate implements Comparable {
    ...
    /*
     * removed as this removed valid decoders that happen to decode to the same thing for the current public boolean equals(Object obj) {
     * LocaleUtilDecoderCandidate other = (LocaleUtilDecoderCandidate) obj; if ( value == null && other.value == null ){ return( true ); }else if (
     * value == null || other.value == null ){ return( false ); }else{ return( value.equals( other.value )); } }
     */
}