...
public class SimpleTimer {
    /**
     * A simple timer class for use by application components that want to schedule low-overhead events (i.e. when fired the event shouldn't take
     * significant processing time as there is a limited thread pool to service it
     */
    ...
    static {
        ...
        addPeriodicEvent("SimpleTimer:ticker", 1000, new TimerEventPerformer() {
    ...
    public interface TimerTickReceiver {
        public void tick(long mono_now, int tick_ount);
    }
}
