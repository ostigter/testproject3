...
public interface TRTrackerServer {
    ...
    public TRTrackerServerTorrent permit(String originator, byte[] hash, boolean explicit)

    throws TRTrackerServerException;

    public TRTrackerServerTorrent permit(String originator, byte[] hash, boolean explicit, boolean enabled)

    throws TRTrackerServerException;

    public void deny(byte[] hash, boolean explicit)
    ...
    public void setBiasedPeers(Set ips);
