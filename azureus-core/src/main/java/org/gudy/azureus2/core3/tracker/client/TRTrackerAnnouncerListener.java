...
public interface TRTrackerAnnouncerListener {
    ...
    /**
     * This callback indicates if the tracker client has change URL. If "explicit" is true then this was via a call to the "setTrackerURL" method on
     * TRTrackerClient. If false then the selected URL has changed because it is a multi-tracker torrent
     * 
     * @param explicit
     *            as above
     */
