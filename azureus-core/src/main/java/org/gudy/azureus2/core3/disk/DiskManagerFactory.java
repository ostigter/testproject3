...
public class DiskManagerFactory {
    ...
    /*
     * public static DiskManager createNoStart( TOTorrent torrent, DownloadManager manager) { return( new DiskManagerImpl( torrent, manager )); }
     */
    ...
    /**
     * Sets resume data complete apart from a few random pieces. On torrent start these will be checked This is used in the "open for seeding" mode to
     * ensure that there's at least a chance that the data they claim represents the data for the torrent is valid
     * 
     * @param torrent
