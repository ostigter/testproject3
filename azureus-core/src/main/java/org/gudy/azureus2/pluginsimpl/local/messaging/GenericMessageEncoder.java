...
public class GenericMessageEncoder implements MessageStreamEncoder {
    public RawMessage[] encodeMessage(Message _message) {
        ...
        if (message.isAlreadyEncoded()) {
            ...
            return (new RawMessage[] { new RawMessageImpl(message, new DirectByteBuffer[] { payload }, RawMessage.PRIORITY_NORMAL, true, // send
                                                                                                                                         // immediately
                    new Message[0]) });
            ...
            return (new RawMessage[] { new RawMessageImpl(message, new DirectByteBuffer[] { header, payload }, RawMessage.PRIORITY_NORMAL, true, // send
                                                                                                                                                 // immediately
                    new Message[0]) });
        }
    }
