...
public class RPIPFilter extends RPObject implements IPFilter {
    ...
    public RPReply _process(RPRequest request) {
        ...
        if (method.equals("createAndAddRange[String,String,String,boolean]")) {
            ...
            IPRange range =
                    delegate.createAndAddRange((String) params[0], (String) params[1], (String) params[2], ((Boolean) params[3]).booleanValue());
    ...
    public IPRange createAndAddRange(String description, String start_ip, String end_ip, boolean this_session_only) {
        RPIPRange resp =
                (RPIPRange) _dispatcher.dispatch(
                        new RPRequest(this, "createAndAddRange[String,String,String,boolean]", new Object[] { description, start_ip, end_ip,
                                new Boolean(this_session_only) })).getResponse();
    ...
    public IPRange[] getRanges() {
        RPIPRange[] resp = (RPIPRange[]) _dispatcher.dispatch(new RPRequest(this, "getRanges", null)).getResponse();
