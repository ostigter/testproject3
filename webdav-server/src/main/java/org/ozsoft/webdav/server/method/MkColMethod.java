...
public class MkColMethod extends AbstractMethod {
	...
	/** Method name. */
	private static final String NAME = "MKCOL";
	
	/** Logger. */
	private static final Logger LOG = Logger.getLogger(MkColMethod.class);
	...
	public void process(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (LOG.isDebugEnabled()) {
				LOG.debug(String.format("Created collection '%s'", uri));
			}
