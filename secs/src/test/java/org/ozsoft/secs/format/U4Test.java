...
public class U4Test {
    ...
    public void singleValue() {
        ...
        TestUtils.assertEquals(new byte[] {(byte) 0xb1, 0x00}, u4.toByteArray());
        ...
        TestUtils.assertEquals(new byte[] {(byte) 0xb1, 0x01, 0x00, 0x00, 0x00, 0x00}, u4.toByteArray());
        
        u4 = new U4(0x00000001L);
        Assert.assertEquals(1, u4.length());
        Assert.assertEquals(1L, (long) u4.getValue(0));
        Assert.assertEquals("U4:1 {1}", u4.toSml());
        TestUtils.assertEquals(new byte[] {(byte) 0xb1, 0x01, 0x00, 0x00, 0x00, 0x01}, u4.toByteArray());

        u4 = new U4(0x00000100L);
        Assert.assertEquals(1, u4.length());
        Assert.assertEquals(256L, (long) u4.getValue(0));
        Assert.assertEquals("U4:1 {256}", u4.toSml());
        TestUtils.assertEquals(new byte[] {(byte) 0xb1, 0x01, 0x00, 0x00, 0x01, 0x00}, u4.toByteArray());

        u4 = new U4(0x00000101L);
        Assert.assertEquals(1, u4.length());
        Assert.assertEquals(257L, (long) u4.getValue(0));
        Assert.assertEquals("U4:1 {257}", u4.toSml());
        TestUtils.assertEquals(new byte[] {(byte) 0xb1, 0x01, 0x00, 0x00, 0x01, 0x01}, u4.toByteArray());

        u4 = new U4(0x000001ffL);
        Assert.assertEquals(1, u4.length());
        Assert.assertEquals(511L, (long) u4.getValue(0));
        Assert.assertEquals("U4:1 {511}", u4.toSml());
        TestUtils.assertEquals(new byte[] {(byte) 0xb1, 0x01, 0x00, 0x00, (byte) 0x01, (byte) 0xff}, u4.toByteArray());

        u4 = new U4(0x0000ffffL);
        Assert.assertEquals(1, u4.length());
        Assert.assertEquals(65535L, (long) u4.getValue(0));
        Assert.assertEquals("U4:1 {65535}", u4.toSml());
        TestUtils.assertEquals(new byte[] {(byte) 0xb1, 0x01, 0x00, 0x00, (byte) 0xff, (byte) 0xff}, u4.toByteArray());
    }
