 ...
 */
public class SmallDate2 implements Comparable<SmallDate2> {
    ...
    public SmallDate2(int day, int month, int year) {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof SmallDate2) {
            return ((SmallDate2) obj).hashCode() == hashCode();
        } else {
            return false;
        }
    }
    ...
    @Override
    public int compareTo(SmallDate2 date) {
    ...
    public static SmallDate2 parseDate(String s) throws Exception {
    	if (s == null) {
        ...
        try {
            ...
            return new SmallDate2(day, month, year);
        } catch (Exception ex) {
    ...
    public void deserialize(DataInputStream dis) throws IOException {
        ...
        // Parse date.
        year  = value / DAYS_PER_YEAR + MIN_YEAR;
        month = (value % DAYS_PER_YEAR) / DAYS_PER_MONTH + 1;
        day = (value % DAYS_PER_YEAR) % DAYS_PER_MONTH + 1;
    }
     ...
     */
    public static SmallDate2 parseIsoDate(String s) {
