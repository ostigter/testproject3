 ...
 * 
 * An optional input document may be set.
 * The input XML document must be located in the project directory.
 * 
 * Namespaces mappings are automatically extracted from the input document
 * so they can be used in the XPath expression. 
 * 
...
public class XPathEvaluator {
	...
	/**
	 * Retrieves the namespace declarations from the input document
	 * and stores them in the namespace resolver.
	 */
