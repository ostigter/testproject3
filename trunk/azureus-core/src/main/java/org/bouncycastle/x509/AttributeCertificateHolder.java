...
public class AttributeCertificateHolder implements CertSelector, Selector {
    ...
    public AttributeCertificateHolder(X509Principal issuerName, BigInteger serialNumber) {
        holder =
                new org.bouncycastle.asn1.x509.Holder(new IssuerSerial(new GeneralNames(new DERSequence(new GeneralName(issuerName))),
     ...
     * <li>2 - otherObjectDigest - A hash of some other object type must be passed. <code>otherObjectTypeID</code> must not be empty.
     * </ul>
     * <p>
     * This cannot be used if a v1 attribute certificate is used.
     * 
     * @param digestedObjectType
     *            The digest object type.
     * @param digestAlgorithm
     *            The algorithm identifier for the hash.
     * @param otherObjectTypeID
     *            The object type ID if <code>digestedObjectType</code> is <code>otherObjectDigest</code>.
     * @param objectDigest
     *            The hash value.
     */
    public AttributeCertificateHolder(int digestedObjectType, String digestAlgorithm, String otherObjectTypeID, byte[] objectDigest) {
        holder =
                new Holder(new ObjectDigestInfo(digestedObjectType, otherObjectTypeID, new AlgorithmIdentifier(digestAlgorithm), Arrays
                        .clone(objectDigest)));
    }
     ...
     * 
     * @return The other object type ID or <code>null</code> if no object digest info is set.
     */
     ...
     * 
     * @return The digest algorithm ID or <code>null</code> if no object digest info is set.
     */
