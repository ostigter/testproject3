 ...
 * </pre>
 * 
 * The provider can also be configured as part of your environment via static registration by adding an entry to the java.security properties file
 * (found in $JAVA_HOME/jre/lib/security/java.security, where $JAVA_HOME is the location of your JDK/JRE distribution). You'll find detailed
...
public final class BouncyCastleProvider extends Provider {
    ...
    /**
     * Construct a new provider. This should only be required when using runtime registration of the provider using the
    ...
    public BouncyCastleProvider() {
        ...
        /*
         * put("Cipher.DES/CFB8", "org.bouncycastle.jce.provider.JCEStreamCipher$DES_CFB8"); put("Cipher.DESEDE/CFB8",
         * "org.bouncycastle.jce.provider.JCEStreamCipher$DESede_CFB8"); put("Cipher.SKIPJACK/CFB8",
         * "org.bouncycastle.jce.provider.JCEStreamCipher$Skipjack_CFB8"); put("Cipher.BLOWFISH/CFB8",
         * "org.bouncycastle.jce.provider.JCEStreamCipher$Blowfish_CFB8"); put("Cipher.TWOFISH/CFB8",
         * "org.bouncycastle.jce.provider.JCEStreamCipher$Twofish_CFB8"); put("Cipher.IDEA/CFB8",
         * "org.bouncycastle.jce.provider.JCEStreamCipher$IDEA_CFB8"); put("Alg.Alias.Cipher.DES/CFB8/NOPADDING", "DES/CFB8");
         * put("Alg.Alias.Cipher.DESEDE/CFB8/NOPADDING", "DESEDE/CFB8"); put("Alg.Alias.Cipher.SKIPJACK/CFB8/NOPADDING", "SKIPJACK/CFB8");
         * put("Alg.Alias.Cipher.BLOWFISH/CFB8/NOPADDING", "Blowfish/CFB8"); put("Alg.Alias.Cipher.TWOFISH/CFB8/NOPADDING", "Twofish/CFB8");
         * put("Alg.Alias.Cipher.IDEA/CFB8/NOPADDING", "IDEA/CFB8"); put("Cipher.DES/OFB8", "org.bouncycastle.jce.provider.JCEStreamCipher$DES_OFB8");
         * put("Cipher.DESEDE/OFB8", "org.bouncycastle.jce.provider.JCEStreamCipher$DESede_OFB8"); put("Cipher.SKIPJACK/OFB8",
         * "org.bouncycastle.jce.provider.JCEStreamCipher$Skipjack_OFB8"); put("Cipher.BLOWFISH/OFB8",
         * "org.bouncycastle.jce.provider.JCEStreamCipher$Blowfish_OFB8"); put("Cipher.TWOFISH/OFB8",
         * "org.bouncycastle.jce.provider.JCEStreamCipher$Twofish_OFB8"); put("Cipher.IDEA/OFB8",
         * "org.bouncycastle.jce.provider.JCEStreamCipher$IDEA_OFB8"); put("Alg.Alias.Cipher.DES/OFB8/NOPADDING", "DES/OFB8");
         * put("Alg.Alias.Cipher.DESEDE/OFB8/NOPADDING", "DESEDE/OFB8"); put("Alg.Alias.Cipher.SKIPJACK/OFB8/NOPADDING", "SKIPJACK/OFB8");
         * put("Alg.Alias.Cipher.BLOWFISH/OFB8/NOPADDING", "BLOWFISH/OFB8"); put("Alg.Alias.Cipher.TWOFISH/OFB8/NOPADDING", "TWOFISH/OFB8");
