...
public class X509Principal extends X509Name implements Principal {
     ...
     * reverse is false the dir name will be encoded in the order of the (name, value) pairs presented, otherwise the encoding will start with the
     * last (name, value) pair and work back.
     */
     ...
     * numeric oids will be processed automatically.
     * <p>
