...
/**
 * Draft FIPS 180-2 implementation of SHA-384. <b>Note:</b> As this is based on a draft this implementation is subject to change.
 * 
 * <pre>
 *         block  word  digest
 * SHA-1   512    32    160
...
public class SHA384Digest extends LongDigest {
    ...
    public void reset() {
        ...
        /*
         * SHA-384 initial hash value The first 64 bits of the fractional parts of the square roots of the 9th through 16th prime numbers
         */
