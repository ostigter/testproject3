...
public class SRP6VerifierGenerator {
     ...
     * @param digest
     *            The digest to use. The same digest type will need to be used later for the actual authentication attempt. Also note that the final
     *            session key size is dependent on the chosen digest.
     */
