...
public class DSAParametersGenerator {
     ...
     * @param certainty
     *            measure of robustness of prime (for FIPS 186-2 compliance this should be at least 80).
     * @param random
     *            random byte source.
     */
    ...
    /**
     * add value to b, returning the result in a. The a value is treated as a BigInteger of length (a.length * 8) bits. The result is modulo
     * 2^a.length in case of overflow.
     */
