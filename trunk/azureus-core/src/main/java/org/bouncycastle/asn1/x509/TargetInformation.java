...
public class TargetInformation extends ASN1Encodable {
     ...
     * 
     * <p>
     * According to RFC 3281 only one targets element must be produced. If multiple targets are given in the constructor they are merged into one
     * targets element. If this was produced from a {@link org.bouncycastle.asn1.ASN1Sequence} the encoding is kept.
     * 
     * @return a DERObject
     */
