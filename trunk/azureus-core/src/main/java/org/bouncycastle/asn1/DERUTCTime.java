...
public class DERUTCTime extends ASN1Object {
    ...
    /**
     * The correct format for this is YYMMDDHHMMSSZ (it used to be that seconds were never encoded. When you're creating one of these objects from
     * scratch, that's what you want to use, otherwise we'll try to deal with whatever gets read from the input stream... (this is why the input
     * format is different from the getTime() method output).
     * <p>
     * 
     * @param time
     *            the time string.
     ...
     * <p>
     * <b>Note:</b> In some cases, due to the local date processing, this may lead to unexpected results. If you want to stick the normal convention
     * of 1950 to 2049 use the getAdjustedTime() method.
     */
