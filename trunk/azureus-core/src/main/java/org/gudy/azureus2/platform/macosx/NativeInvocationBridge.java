 ...
 * </p>
 * <p>
 * The methods supplied are intended to reflect those that can be dealt with a way other than OSAScript. Ensure that the method signatures match those
 * of PlatformManagerImpl, but they should generally return a boolean (false for failure).
 * </p>
 * 
 * @version 1.0
 */
public abstract class NativeInvocationBridge {
    ...
    protected static final NativeInvocationBridge sharedInstance() {
        if (instance == null) {
            try {
                Object newInstance = Class.forName("org.gudy.azureus2.platform.macosx.access.cocoa.CocoaJavaBridge").getConstructor().newInstance();
