...
public interface UpdateChecker {
    ...
    /**
     * For updates that require a stop, update-action and then start you create an installer. This allows the specification of actions such as the
     * replacement of a DLL
     * 
     * @return
     */
    ...
    /**
     * Indicates that the update check failed. Of particular importance for mandatory components (e.g. AZ core) as failure of a mandatory one causes
     * all other updates to be aborted
     */
