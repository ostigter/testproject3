 ...
 * you want to have multiple calculations same time. The message can be passed in one or a sequenze of parts wrapped in a ByteBuffer to the update of
 * the same MD5 instance. To finish the calculation use final, it will reset the MD5 instance for a new calculation.
 * 
 * @author emarant
...
public final class BrokenMd5Hasher {
    ...
    /**
     * Starts or continues a MD5 message digest calculation. input.remaining() should be a multiple of 64 to be most efficant, but other amounts work
     * too. Only remaining bytes of the ByteBuffer are used and input.position() will be input.limit() after return.
     * 
     * @param input
    ...
    /**
     * Finishs a MD5 message digest calculation. The result is stored in digest and the MD5-object is <b>reset</b> and so ready for a new message
     * digest calculation.
     * 
     * @param digest
