...
public class TRTrackerServerFactory {
    ...
    public static TRTrackerServer
            create(String name, int protocol, int port, boolean apply_ip_filter, boolean main_tracker, boolean start_up_ready)
    ...
    public static TRTrackerServer
            createSSL(String name, int protocol, int port, InetAddress bind_ip, boolean apply_ip_filter, boolean main_tracker)
