...
public interface PluginManagerDefaults {
    ...
    PID_START_STOP_RULES, PID_REMOVE_RULES, PID_SHARE_HOSTER, PID_DEFAULT_TRACKER_WEB,
            // PID_UPDATE_LANGUAGE,
            PID_CORE_UPDATE_CHECKER, PID_CORE_PATCH_CHECKER, PID_PLATFORM_CHECKER, PID_UPNP,
            // PID_CLIENT_ID,
            PID_DHT, PID_DHT_TRACKER, PID_MAGNET,
            // PID_JPC,
            PID_EXTERNAL_SEED, PID_LOCAL_TRACKER, PID_TRACKER_PEER_AUTH, PID_NET_STATUS, PID_BUDDY, PID_RSS, };
    ...
    public void setApplicationIdentifier(String identifier);

    public String getApplicationIdentifier();

    public void setApplicationEntryPoint(String entry_point);
