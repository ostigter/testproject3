...
public interface DownloadManagerInitialisationAdapter {
    ...
    /**
     * Unfortuately order can be important when firing off initialisation adapters, in particular if one listener assigns tags to a download it needs
     * to do this before any other listeners that might process a download's tags
     * 
     * @return
     */
