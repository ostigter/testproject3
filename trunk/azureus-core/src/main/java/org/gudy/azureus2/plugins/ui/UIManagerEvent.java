...
public interface UIManagerEvent {
    ...
    public static final int ET_OPEN_TORRENT_VIA_URL = 3; // data is Object[]{URL,URL,Boolean} - { torrent_url, referrer url, auto_download, Map
                                                         // request_properties}
