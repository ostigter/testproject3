...
public class TRTrackerServerRequestImpl implements TRTrackerServerRequest {
    ...
    public TRTrackerServerRequestImpl(TRTrackerServerImpl _server, TRTrackerServerPeer _peer, TRTrackerServerTorrent _torrent, int _type,
            String _request, Map _response) {
        server = _server;
        peer = _peer;
        torrent = _torrent;
        type = _type;
