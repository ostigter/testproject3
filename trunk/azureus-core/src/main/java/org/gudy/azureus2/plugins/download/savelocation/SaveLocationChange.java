...
/**
 * Used by {@link SaveLocationManager} - you create an instance, set the attributes here and return the value.
 * 
 * @since 3.0.5.3
 */
public class SaveLocationChange {
    ...
    public final File normaliseTorrentLocation(File old_torrent_directory, String old_torrent_name) {
        return new File((torrent_location != null) ? torrent_location : old_torrent_directory, (torrent_name != null) ? torrent_name
                : old_torrent_name);
    }
    ...
    public final File normaliseDownloadLocation(File old_download_directory, String old_download_name) {
        return new File((download_location != null) ? download_location : old_download_directory, (download_name != null) ? download_name
                : old_download_name);
    }

    /**
     * Returns <tt>true</tt> if this object indicates a new location for a download.
     */
    ...
    /**
     * Returns <tt>true</tt> if this object indicates a new location for a torrent.
     */
    ...
    /**
     * Returns <tt>true</tt> if this object represents a download location different to the one provided - it will check whether the location
    ...
    /**
     * Returns <tt>true</tt> if this object represents a torrent location different to the one provided - it will check whether the location
     * represented here is already the same as the one provided.
     */
