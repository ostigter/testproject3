...
public interface TRTrackerScraperClientResolver {
    ...
    /**
     * Two kinds of extensions: entry [0] = String (or null) that gets passed with the scrape verbotem after infohash entry [1] = Character - status
     * of download, aggregated into a single String passed with scrape status flags are above FL_ values
     * 
     * @param hash
     * @return
     */
