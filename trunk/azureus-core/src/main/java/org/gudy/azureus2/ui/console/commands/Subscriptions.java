    ...
    public void execute(String commandName, ConsoleInput ci, List<String> args) {
        ...
        if (cmd.equals("list")) {
            ...
            for (Subscription sub : current_subs) {
                ...
                String str =
                        index_str + sub.getName() + ", unread=" + history.getNumUnread() + ", auto_download="
                                + (history.isAutoDownload() ? "yes" : "no");
        ...
        } else if (cmd.equals("update") || cmd.equals("results") || cmd.equals("set_autodownload") || cmd.equals("set_updatemins")
                || cmd.equals("set_read") || cmd.equals("set_unread") || cmd.equals("download") || cmd.equals("delete")) {
            ...
            if (current_sub == null) {
                ...
                } else if (cmd.equals("set_read") || cmd.equals("set_unread") || cmd.equals("download")) {
                            ...
                            for (SubscriptionResult result : to_do) {
                                ...
                                if (cmd.equals("set_read")) {
                                    ...
                                    try {
                                        ...
                                        ci.out.println("Failed to add download from URL '" + download_link + "': "
