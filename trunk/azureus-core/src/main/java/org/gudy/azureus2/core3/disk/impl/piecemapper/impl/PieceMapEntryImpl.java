...
public class PieceMapEntryImpl implements DMPieceMapEntry {
    /**
     * This class denotes the mapping of a piece onto a file. Typically a piece can span multiple files. Each overlapping segment has on of these
     * entries created for it. It identifies the file, the offset within the file, and the length of the chunk
     */
