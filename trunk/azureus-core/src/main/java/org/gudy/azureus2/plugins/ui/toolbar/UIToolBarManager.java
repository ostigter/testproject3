...
public interface UIToolBarManager {
    ...
    /**
     * Create a new {@link UIToolBarItem}. You will still need to add it via {@link #addToolBarItem(UIToolBarItem)}, after setting the item's
     * properties
     * 
     * @param id
     *            unique id
    ...
    /**
     * Adds a {@link UIToolBarItem} to the UI. Make sure you at least set the icon before adding
     * 
     * @param item
     */
