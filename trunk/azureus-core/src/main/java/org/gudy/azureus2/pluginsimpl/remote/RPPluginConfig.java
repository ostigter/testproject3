...
public class RPPluginConfig extends RPObject implements PluginConfig {
    ...
    protected void _setDelegate(Object _delegate) {
        ...
        cached_property_names =
                new String[] { CORE_PARAM_INT_MAX_UPLOAD_SPEED_KBYTES_PER_SEC, CORE_PARAM_INT_MAX_UPLOAD_SPEED_SEEDING_KBYTES_PER_SEC,
                        CORE_PARAM_INT_MAX_DOWNLOAD_SPEED_KBYTES_PER_SEC, CORE_PARAM_INT_MAX_CONNECTIONS_PER_TORRENT,
                        CORE_PARAM_INT_MAX_CONNECTIONS_GLOBAL, CORE_PARAM_INT_MAX_DOWNLOADS, CORE_PARAM_INT_MAX_ACTIVE,
                        CORE_PARAM_INT_MAX_ACTIVE_SEEDING, CORE_PARAM_INT_MAX_UPLOADS, CORE_PARAM_INT_MAX_UPLOADS_SEEDING };

        cached_property_values =
                new Object[] { new Integer(delegate.getIntParameter(cached_property_names[0])),
    ...
    public RPReply _process(RPRequest request) {
        ...
        } else if (method.equals("getIntParameter[String,int]") || method.equals("getParameter[String,int]")) {
    ...
    public int getIntParameter(String key, int default_value) {
        ...
        if (res == null) {
            ...
            res =
                    (Integer) _dispatcher.dispatch(
                            new RPRequest(this, "getIntParameter[String,int]", new Object[] { key, new Integer(default_value) })).getResponse();
        }
    ...
    public int getPluginIntParameter(String key, int defaultValue) {
        Integer res =
                (Integer) _dispatcher.dispatch(
                        new RPRequest(this, "getPluginIntParameter[String,int]", new Object[] { key, new Integer(defaultValue) })).getResponse();
    ...
    public String getPluginStringParameter(String key, String defaultValue) {
        String res =
                (String) _dispatcher.dispatch(new RPRequest(this, "getPluginStringParameter[String,String]", new Object[] { key, defaultValue }))
                        .getResponse();
    ...
    public void setUnsafeColorParameter(String key, int[] default_value, boolean override) {
        notSupported();
    }
