...
public interface UTTimer {
    ...
    public UTTimerEvent addEvent(long when, UTTimerEventPerformer performer);
    ...
    public UTTimerEvent addPeriodicEvent(long periodic_millis, UTTimerEventPerformer performer);
