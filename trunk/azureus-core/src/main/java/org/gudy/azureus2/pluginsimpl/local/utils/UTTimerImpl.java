                ...
                UtilitiesImpl.callWithPluginThreadContext(plugin_interface, new Runnable() {
                    public void run() {
                        try {
                            ...
                            Debug.out("Plugin '" + plugin_interface.getPluginName() + " (" + plugin_interface.getPluginID() + " "
                                    + plugin_interface.getPluginVersion() + ") caused an error while processing a timer event", e);
                        }
                    }
                });
            }
