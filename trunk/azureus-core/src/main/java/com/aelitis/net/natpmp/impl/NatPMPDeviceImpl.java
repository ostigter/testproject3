...
public class NatPMPDeviceImpl implements NatPMPDevice {
    ...
    /**
     * Send a request and wait for reply This class should be threaded!!!
     * 
     * This sends to the default NATPMP_PORT.
     * 
     * @param dstInet
     *            destination address (should be the private NAT address)
     * @param dstPkt
     *            packet to send
     * @param recBuf
    ...
    public boolean connect() throws Exception {
        ...
        try {
            ...
            String recPubAddr =
                    unsigned8ByteArrayToInt(recBuf, 8) + "." + unsigned8ByteArrayToInt(recBuf, 9) + "." + unsigned8ByteArrayToInt(recBuf, 10) + "."
            ...
            /**
             * TO DO: Set up listner for announcements from the device for address changes (public address changes)
             **/
     ...
     * 
     * NAP-PMP allows the device to assign another public port if the requested one is taken. So, you should check the returned port.
     * 
     * @param tcp
     *            true TCP, false UDP
    ...
    public int addPortMapping(boolean tcp, int publicPort, int privatePort) throws Exception {
        ...
        return portMappingProtocol(tcp, publicPort, privatePort, NATMAP_DEFAULT_LEASE);
    }
     ...
     * 
     * @param tcp
     *            true TCP, false UDP port
     * @param publicPort
     *            the public port to close
     * @param privatePort
    ...
    public void deletePortMapping(boolean tcp, int publicPort, int privatePort) throws Exception {
        /**
         * if the request was successful, a zero lifetime will delete the mapping and return a public port of 0
         **/
        // check for actual connection
    ...
    public int portMappingProtocol(boolean tcp, int publicPort, int privatePort, int lifetime) throws Exception {
        ...
        /**
         * Should save the epoch. This can be used to determine the time the mapping will be deleted.
         **/
