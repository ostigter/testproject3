...
public interface MagnetURIHandlerListener {
    ...
    public byte[] download(MagnetURIHandlerProgressListener progress, byte[] hash, String args, InetSocketAddress[] sources, long timeout)

    throws MagnetURIHandlerException;

    public boolean download(URL magnet_url)
