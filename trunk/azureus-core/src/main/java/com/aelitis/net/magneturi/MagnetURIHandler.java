...
public abstract class MagnetURIHandler {
    ...
    public abstract void process(String get, InputStream is, OutputStream os)
    ...
    public abstract void addInfo(String name, int info);

    public abstract URL registerResource(ResourceProvider provider);
