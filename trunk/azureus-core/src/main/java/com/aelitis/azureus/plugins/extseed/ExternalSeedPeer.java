...
public class ExternalSeedPeer implements Peer, ExternalSeedReaderListener {
    ...
    private class ESConnection implements Connection {
        private OutgoingMessageQueue out_q = new OutgoingMessageQueue() {
        ...
        private IncomingMessageQueue in_q = new IncomingMessageQueue() {
            ...
            public int getPercentDoneOfCurrentMessage() {
                return (ExternalSeedPeer.this.getPercentDoneOfCurrentIncomingRequest());
            }
        };
