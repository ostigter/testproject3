...
public class CLCacheDiscovery implements CacheDiscoverer {
    ...
    private String hashAnnounceURL(URL announce_url) {
        ...
        /*
         * Return first 32 characters of the hexadecimal representation of the SHA1 hash.
         */
    ...
    public InetAddress[] findCache(URL announce_url, String hex_hash) {
        ...
        /*
         * Build the hostname for the DNS query: bt-<short hash>.bt-<announce hash>-<farm>.find-cache.com short hash: first four hexadecimal digits of
         * the BitTorrent hash announce hash: see hashAnnounceURL() farm: farm name returned by CDP query.
         */
        Hostname = "bt-" + hex_hash.substring(0, 4) + ".bt-" + hashAnnounceURL(announce_url) + "-" + lookupFarm() + CDPDomainName;
