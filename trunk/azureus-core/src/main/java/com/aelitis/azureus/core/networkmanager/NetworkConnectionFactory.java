...
public class NetworkConnectionFactory {
    private static CopyOnWriteList<NetworkConnectionFactoryListener> listeners =
            new CopyOnWriteList<NetworkConnectionFactory.NetworkConnectionFactoryListener>();
     ...
     */
    protected static NetworkConnection create(ConnectionEndpoint target, MessageStreamEncoder encoder, MessageStreamDecoder decoder,
    ...
    public interface NetworkConnectionFactoryListener {
        public void connectionCreated(NetworkConnection connection);
    }
}
