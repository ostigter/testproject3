...
public class DHTUDPPacketReplyQueryStorage extends DHTUDPPacketReply {
    ...
    public DHTUDPPacketReplyQueryStorage(DHTTransportUDPImpl transport, int trans_id, long conn_id, DHTTransportContact local_contact,
    ...
    protected DHTUDPPacketReplyQueryStorage(DHTUDPPacketNetworkHandler network_handler, InetSocketAddress originator, DataInputStream is,
            int trans_id)
