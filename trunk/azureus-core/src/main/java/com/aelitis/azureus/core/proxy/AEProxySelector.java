...
public interface AEProxySelector {
    ...
    public Proxy getSOCKSProxy(InetSocketAddress proxy_address, InetSocketAddress target);

    public Proxy getSOCKSProxy(String proxy_host, int proxy_port, InetSocketAddress target);
