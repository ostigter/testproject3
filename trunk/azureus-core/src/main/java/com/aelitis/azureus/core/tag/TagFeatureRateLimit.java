...
public interface TagFeatureRateLimit extends TagFeature {
    ...
    public void setRecentHistoryRetention(boolean enable);
    ...
    public void setTagMinShareRatio(int ratio_in_thousandths);

    public int getTagMaxShareRatio();

    public void setTagMaxShareRatio(int ratio_in_thousandths);
}
