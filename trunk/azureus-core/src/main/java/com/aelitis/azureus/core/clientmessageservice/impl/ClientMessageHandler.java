...
public interface ClientMessageHandler {
    ...
    /**
     * Notification of reply message send attempt completion. NOTE: This method will always be called once for every preceeding
     * ClientMessageServer.sendReplyMessage() call.
     * 
     * @param message
     *            sent
     * @param success
     *            true if reply send was successful, false if reply send failed
     */
