...
public class DeviceiTunes extends DeviceMediaRendererImpl implements DeviceMediaRenderer {
    ...
    protected void updateiTunesStatus() {
        ...
        try {
            ...
            /*
             * List<Map<String,Object>> sources = (List<Map<String,Object>>)properties.get( "sources" ); if ( sources != null ){ for (
             * Map<String,Object> source: sources ){ System.out.println( source ); } }
             */
    ...
    protected void setCopyOutstanding() {
        synchronized (this) {
            ...
            if (copy_thread == null) {
                ...
                copy_thread = new AEThread2("Device:copier", true) {
                    public void run() {
                        performCopy();
                    }
                };
