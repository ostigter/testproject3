...
public abstract class ClientMessageContextImpl implements ClientMessageContext {
    ...
    public void addMessageListener(BrowserMessageListener listener) {
        if (dispatcher != null) {
            ...
            debug("No dispatcher when trying to add MessageListener " + listener.getId() + ";" + Debug.getCompressedStackTrace());
        }
    }
    ...
    public void removeMessageListener(String listenerId) {
        if (dispatcher != null) {
            ...
            debug("No dispatcher when trying to remove MessageListener " + listenerId + ";" + Debug.getCompressedStackTrace());
        }
    }
    ...
    public void removeMessageListener(BrowserMessageListener listener) {
        if (dispatcher != null) {
            ...
            debug("No dispatcher when trying to remove MessageListener " + listener.getId() + ";" + Debug.getCompressedStackTrace());
        }
    }
