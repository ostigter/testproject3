...
public class TranscodeProviderVuze implements TranscodeProvider {
    ...
    public TranscodeProfile[] getProfiles() {
        ...
        try {
            Map<String, Map<String, Object>> profiles_map =
                    (Map<String, Map<String, Object>>) plugin_interface.getIPC().invoke("getProfiles", new Object[] {});
    ...
    public TranscodeProviderAnalysis analyse(final TranscodeProviderAdapter _adapter, DiskManagerFileInfo input, TranscodeProfile profile)
    ...
    public TranscodeProviderJob transcode(final TranscodeProviderAdapter _adapter, TranscodeProviderAnalysis analysis, boolean direct_input,
            DiskManagerFileInfo input, TranscodeProfile profile, URL output)
        ...
        try {
            ...
            try {
                ...
                if (output.getProtocol().equals("tcp")) {
                    ...
                    context =
                            ipc.invoke("transcodeToTCP", new Object[] { ((TranscodeProviderAnalysisImpl) analysis).getResult(), source_url,
                                    profile.getName(), output.getPort() });
                } else {
                    ...
                    context =
                            ipc.invoke("transcodeToFile", new Object[] { ((TranscodeProviderAnalysisImpl) analysis).getResult(), source_url,
                                    profile.getName(), file });
                }
