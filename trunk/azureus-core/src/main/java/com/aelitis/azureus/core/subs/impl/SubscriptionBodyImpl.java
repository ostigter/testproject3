...
public class SubscriptionBodyImpl {
    ...
    protected SubscriptionBodyImpl(SubscriptionManagerImpl _manager, String _name, boolean _is_public, String _json_content, byte[] _public_key,
            int _version, int _az_version, Map _singleton_details)
