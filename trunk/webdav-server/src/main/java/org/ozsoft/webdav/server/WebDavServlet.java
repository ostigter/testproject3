...
//	response.addHeader("MS-Author-Via", "DAV"); // Required for Microsoft Windows Explorer?
    ...
    // dom4j
    private void doPropfind(HttpServletRequest request, HttpServletResponse response) throws ServletException,
	    IOException {
...
//	response.addHeader("MS-Author-Via", "DAV");
     ...
     *            The property responses.
     */
    private void doPropfindAllprop(String uri, Depth depth, List<WebDavResponse> responses) throws ServletException,
     ...
     *            The property responses.
     */
    private void doPropfindPropname(String uri, Depth depth, List<WebDavResponse> responses) throws ServletException,
	    IOException {
	// TODO
    }
     ...
     *            The response.
     */
    private void doMkCol(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	String uri = getUriFromRequest(request);
	LOG.debug("MKCOL " + uri);
	try {
     ...
     *            The response.
     */
    private void doMove(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	String uri = getUriFromRequest(request);
	LOG.debug("MOVE " + uri);
