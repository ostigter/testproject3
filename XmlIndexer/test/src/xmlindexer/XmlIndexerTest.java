...
public class XmlIndexerTest {
    ...
    public void main() {
        Index docIdIndex =
                new Index("DocumentId", "/FooDocument/Header/Id");
        Index docTypeIndex =
                new Index("DocumentType", "/FooDocument/Header/Type");                 
        Index docVersionIndex =
                new Index("DocumentVersion", "/FooDocument/Header/Version");                 
